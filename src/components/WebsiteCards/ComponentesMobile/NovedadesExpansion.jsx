import "./NovedadesExpansion.scss"

export default function NovedadesExpansion() {
    return (
        <>
            ...
            <div className="novedades-de-la-expansion" style={{ display: "none" }}>
                <div className="contenedor">
                    ...
                    <div className="contenido">
                        <div className="titulo">
                            <h4> EL REGRESO DE LAS CARTAS DE AS TÁCTICO </h4>
                        </div>
                        <div className="texto">
                    ...
                    <div className="contenido">
                        <div className="titulo">
                            <h4> LLEGAN MÁS POKÉMON PARADOJA </h4>
                        </div>
                        <div className="texto">
                    ...
                    <div className="contenido">
                        <div className="titulo">
                            <h4> POKÉMON REUNIDOS EN LAS CARTAS DE RAREZA RARA ILUSTRACIÓN </h4>
                        </div>
                        <div className="texto">
                    ...
                    <div className="contenido">
                        <div className="titulo">
                            <h4> FUERZA DEL PASADO Y DEL FUTURO </h4>
                        </div>
                        <div className="texto">
